...
const style = createCSSSheet(css`
  ...
  dy-divider {
    margin: calc(2 * ${theme.gridGutter}) auto;
    max-width: 30em;
  }
  footer {
...
export class MFooterElement extends GemElement {
  render = () => {
    return html`
      <div class="links">
        <dy-link href=${githubUrl} aria-label="Github">
        ...
        <dy-link href="https://discord.gg/T2mtdDPF" aria-label="Discord">
        ...
        <dy-link href="https://twitter.com/nesbox_online" aria-label="Twitter">
